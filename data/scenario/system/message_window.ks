;メッセージレイヤの定義
		...
		[position width=864 height=180 top=500 left=210 ]


		
			[position page=fore frame="window.png" margint=10 marginl=40 marginr=40 marginb=10 vertical=false opacity="255" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xf3efe0 size=1 x=30 y=427 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=864 height=180 top=500 left=210 ]
