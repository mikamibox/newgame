;メッセージレイヤの定義
		...
		[position width=864 height=180 top=420 left=50 ]


		
			[position page=fore frame="window.png" margint=10 marginl=40 marginr=10 marginb=10 vertical=false opacity="255" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xf3efe0 size=26 x=7 y=0 bold="" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=864 height=180 top=420 left=50 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="255" radius="30" color="0x5f6f52" ]
